...
@click.option('--arch',         help='Path to the json of model architecture', metavar='STR',   type=str, default=None)
...
def main(**kwargs):
    ...
    if opts.cfg == 'stylegan2':
        ...
        if opts.arch is not None:
            with open(opts.arch, 'r') as f:
                c.G_kwargs.kernel_size_dict = json.load(f) # e.g., {4: 3, 8: 3, 16: 3, 32: 3, 64: 3, 128: 5, 256: 5}
